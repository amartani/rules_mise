...
# By default all these toolchains are registered by the mise_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:mise_toolchain",
    toolchain_type = "@rules_mise//mise:toolchain_type",
)
""".format(
            platform = platform,
